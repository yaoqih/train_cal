...
| depot_earliness | 233.11 | 1754 | 231.17 | 1754 |

**Earliness 总和**：OFF=14919，ON=14795，绝对下降 124，相对下降 0.8% 。
...
| `beam` | 15 | 18 |
| `beam_greedy_64` | 3 | 0 |
| `constructive_partial+rescue` | 12 | 12 |
| `exact` | 34 | 34 |
...
- OFF 均值：0.400，ON 均值：0.510，理论上限均值：0.889
- ON 相对 OFF 向理论上限的空间收敛度：均值 31.4%（0% = 没挪，100% = 达到理论上限）
  - p25/p50/p75: 0.0% / 0.0% / 100.0%

## 8. 结论

- 配对样本 64 个场景，主目标总勾数 OFF=2694、ON=2694，变化 +0（净改善或持平）。
- **没有任何场景的勾数因开启而增加**，mitigation 生效。
- Earliness 总和 OFF=14919、ON=14795，变化 -124。
